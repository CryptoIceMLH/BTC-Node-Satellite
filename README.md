...
please visi thttps://github.com/CryptoIceMLH/BitSatRelay for the software part of the project 
...
Research and Development into an integrated system that will allow a BTC node / Nostr Relay to communicate via satellite to another node/relay.


## Purpose

is to decentralize Bitcoin and Nostr communications by providing an alternative to centralized Internet Service providers.

hardware is off the shelf 
write up needs finilising now that i have come to a final design amd architecture. 
